      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-6 sm:px-10 lg:px-14">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="grid size-10 place-items-center rounded-xl bg-lime font-black text-ink">R</div>
            <span className="font-display text-xl">Recall</span>
          </div>
          <button className="button-dark-ghost" onClick={onSignIn}>
        ...
        <div className="grid flex-1 items-center gap-16 py-16 lg:grid-cols-[1.1fr_0.9fr]">
          <section>
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.06] px-3 py-1.5 text-xs font-semibold text-white/65">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <button className="button-light" onClick={onSignUp}>
          ...
          <section className="relative hidden lg:block">
            ...
            <div className="relative rotate-2 rounded-[2rem] border border-white/10 bg-white/[0.07] p-5 shadow-modal backdrop-blur-xl">
              <div className="rounded-[1.5rem] bg-canvas p-6 text-ink">
                ...
                <div className="mt-6 space-y-3">
                  {["Minimum Window Substring", "Course Schedule", "Coin Change"].map(
                    (name, index) => (
                      <div key={name} className="flex items-center gap-3 rounded-2xl bg-white p-4 shadow-card">
                ...
                <div className="mt-5 grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-2xl bg-accent-soft p-4 text-accent-dark">
                    <LockKeyhole size={16} />
                    <p className="mt-4 text-sm font-bold">Only yours</p>
                    <p className="mt-1 text-[10px] text-accent-dark/55">Account-scoped data</p>
                  </div>
                </div>
              </div>
            </div>
...
function AuthCallbackError({ onRetry }: { onRetry: () => void }) {
  return (
    <main className="grid min-h-screen place-items-center bg-canvas px-6">
      <section className="w-full max-w-md rounded-[2rem] border border-line bg-white p-8 text-center shadow-soft sm:p-10">
