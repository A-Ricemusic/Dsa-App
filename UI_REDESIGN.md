...
| Overview                 | A large greeting banner and separate statistic cards pushed useful data down the page.            | Compact heading, inline statistics, review queue, and recent practice table.                                                       |
